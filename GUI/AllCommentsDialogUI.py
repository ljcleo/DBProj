...
class Ui_AllCommentsDialog(object):
    ...
    def retranslateUi(self, AllCommentsDialog):
        ...
        AllCommentsDialog.setWindowTitle(_translate("AllCommentsDialog", "个人主页"))
        ...
        self.CommentLabel.setText(_translate("AllCommentsDialog", "用户昵称 的评论"))
        self.UserName.setText(_translate("AllCommentsDialog", "用户昵称"))
