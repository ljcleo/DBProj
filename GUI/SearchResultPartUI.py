...
class Ui_SearchResultPart(object):
    ...
    def retranslateUi(self, SearchResultPart):
        ...
        item.setText(_translate("SearchResultPart", "主演"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("SearchResultPart", "评分"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.item(0, 0)
        item.setText(_translate("SearchResultPart", "疯狂动物城"))
        ...
        item.setText(_translate("SearchResultPart", "冰雪奇缘"))
        ...
        item.setText(_translate("SearchResultPart", "冰雪奇缘2"))
        ...
        item.setText(_translate("SearchResultPart", "海洋奇缘"))
        ...
        item.setText(_translate("SearchResultPart", "魔发奇缘"))
        ...
        item.setText(_translate("SearchResultPart", "小美人鱼"))
        ...
        item.setText(_translate("SearchResultPart", "狮子王"))
        ...
        item.setText(_translate("SearchResultPart", "阿拉丁"))
        ...
        item.setText(_translate("SearchResultPart", "花木兰"))
