...
class Ui_HomepagePart(object):
    def setupUi(self, HomepagePart):
        ...
        self.RecommendationPic2 = QtWidgets.QLabel(self.RecommendationFrame)
        self.RecommendationPic2.setGeometry(QtCore.QRect(250, 80, 180, 254))
        ...
        self.RecommendationPic3 = QtWidgets.QLabel(self.RecommendationFrame)
        self.RecommendationPic3.setGeometry(QtCore.QRect(480, 80, 180, 254))
        ...
        self.RecommendationPic1 = QtWidgets.QLabel(self.RecommendationFrame)
        self.RecommendationPic1.setGeometry(QtCore.QRect(20, 80, 180, 254))
